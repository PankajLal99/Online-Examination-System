...
import cv2
import numpy as np
from Exam.Proctoring.face_detector import get_face_detector, find_faces
from Exam.Proctoring.face_landmarks import get_landmark_model, detect_marks
...
def start():
    ...
    cv2.createTrackbar('threshold', 'eyes', 75, 255, nothing)
